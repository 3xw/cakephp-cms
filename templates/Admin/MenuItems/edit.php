      ...
      <div class="card-body">
        <div class="row">
          <div class="col-sm-8">
            ...
            <?php // $this->Form->control('page', ['empty' => ' ', 'type' => 'select', 'options' => $pages,  'class'=>'form-control menu-item__page-select' , 'data-model' => 'Pages']);?>
            <?php // $this->Form->control('model',['type' => 'hidden', 'value' => NULL, 'class'=>'form-control menu-item__model']);?>
            <?php // $this->Form->control('foreign_key',['type' => 'hidden', 'value' => NULL, 'class'=>'form-control']);?>
